...
public class AddrBook {
	...
	private String ab_kid;
	private String ab_job;
	...
	public void setAb_sex(String ab_sex) {
		this.ab_sex = ab_sex;
	}
	public String getAb_kid() {
		return ab_kid;
	}
	public void setAb_kid(String ab_kid) {
		this.ab_kid = ab_kid;
	}
	public String getAb_job() {
		return ab_job;
	}
	public void setAb_job(String ab_job) {
		this.ab_job = ab_job;
	}
