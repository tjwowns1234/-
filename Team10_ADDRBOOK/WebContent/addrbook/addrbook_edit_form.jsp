<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" errorPage="addrbook_error.jsp" import="jspbook.addrbook.AddrBook"%>
<!DOCTYPE HTML>
<html>
<head>
...
<table border="1">
  ...
  <tr>
    <th>성 별</th>
    <td><input type="text" name="ab_sex" value="<%=ab.getAb_sex() %>"></td>
  </tr>
  <tr>
  <tr>
    <th>카카오id</th>
    <td><input type="text" name="ab_kid" value="<%=ab.getAb_kid() %>"></td>
  </tr>
  <tr>
  <tr>
    <th>직 업</th>
    <td><input type="text" name="ab_job" value="<%=ab.getAb_job() %>"></td>
  </tr>
  <tr>
